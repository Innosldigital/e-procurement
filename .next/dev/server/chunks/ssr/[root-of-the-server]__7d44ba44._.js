...
async function submitCompanyOnboarding(data) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])();
        const count = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Company$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Company"].countDocuments();
        const companyId = `COMP-${(count + 1000).toString()}`;
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Company$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Company"].create({
            companyId,
        ...
        return {
            success: false,
            error: 'Failed to submit company onboarding'
        };
    }
}
async function submitSupplierOnboarding(data) {
    try {
        const { userId } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$nextjs$2f$dist$2f$esm$2f$app$2d$router$2f$server$2f$auth$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["auth"])();
        if (!userId) return {
            success: false,
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])();
        const count = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Supplier$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Supplier"].countDocuments();
        const supplierId = `SUP-${(count + 5000).toString()}`;
        const supplier = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Supplier$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Supplier"].create({
            supplierId,
            name: data.name,
            approved: false,
            ownerUserId: userId,
        ...
        const client2 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$nextjs$2f$dist$2f$esm$2f$server$2f$clerkClient$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["clerkClient"])();
        ...
        return {
            success: false,
            error: 'Failed to submit supplier onboarding'
        };
    }
}
;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7d44ba44._.js.map