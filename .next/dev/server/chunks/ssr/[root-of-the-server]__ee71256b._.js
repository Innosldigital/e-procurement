...
/* __next_internal_action_entry_do_not_use__ [{"0003eaf9a541d5d6d2d2726bcbd490c6d43f04d4fa":"getEvaluationRules","009c1b24cfc8a0d5c58c1cd4080a01bd9a56656ce0":"getTenderTemplates","00d31d1ccc0b3c052a86488fa58a130d2f96ce8c3a":"getTenders","4010b5d78bb0dba6dc192fd5fd90c317c0070c5601":"getTenderById","403ff369108e49ee3ff886c36c0d25878cfbfa33a0":"requestRevisedBids","409728999fbf9c924e9a1ffbd691eeac56920a90bf":"createTender","60b42215698daa1c57ccb524a745972f1ab6cd2bd6":"submitBid","60e223658425b0d7487a997f4ca8c5742a4806614c":"awardTender"},"",""] */ __turbopack_context__.s([
    "awardTender",
    ()=>awardTender,
    "createTender",
    ()=>createTender,
...
async function getTenderTemplates() {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])();
        const tenders = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Tender$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Tender"].find({}).sort({
            createdAt: -1
        }).lean();
        const templates = (tenders || []).map((t)=>({
                id: String(t._id),
                ...
                mandatoryQuestions: [],
                evaluationWeights: {},
                usageCount: Number(t.responses || (Array.isArray(t.bids) ? t.bids.length : 0) || 0)
            }));
        return {
            success: true,
        ...
        return {
            success: false,
            error: 'Failed to fetch tender templates'
        };
    }
}
async function getEvaluationRules() {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])();
        const rules = [];
        return {
...
async function submitBid(tenderId, data) {
    try {
        const { userId } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$nextjs$2f$dist$2f$esm$2f$app$2d$router$2f$server$2f$auth$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["auth"])();
        if (!userId) {
            return {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])();
        const priceNumber = typeof data.totalPrice === 'number' ? data.totalPrice : Number(String(data.totalPrice).replace(/[^0-9.-]/g, '')) || 0;
        const highlights = [
            data.technicalProposal,
            data.deliveryTimeline,
            data.additionalNotes
        ].filter(Boolean).join(' \u2022 ');
        const update = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Tender$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Tender"].findByIdAndUpdate(tenderId, {
            $push: {
                bids: {
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getTenderTemplates, "009c1b24cfc8a0d5c58c1cd4080a01bd9a56656ce0", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getEvaluationRules, "0003eaf9a541d5d6d2d2726bcbd490c6d43f04d4fa", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(submitBid, "60b42215698daa1c57ccb524a745972f1ab6cd2bd6", null);
}),
];
