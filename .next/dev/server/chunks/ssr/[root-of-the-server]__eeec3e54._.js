...
"[project]/lib/models/Company.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const Company = __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["models"].Company || (0, __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["model"])('Company', CompanySchema);
}),
...
async function approveSupplierOnboarding(supplierId) {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])();
        const supplierDoc = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Supplier$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Supplier"].findOneAndUpdate({
            supplierId
        }, {
            approved: true
        }, {
        ...
        return {
            success: false,
            error: 'Failed to approve supplier onboarding'
        };
    }
}
async function approveCompanyOnboarding(companyId) {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])();
        const companyDoc = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Company$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Company"].findOneAndUpdate({
            companyId
        }, {
            approved: true
        }, {
        ...
        return {
            success: true,
            data: JSON.parse(JSON.stringify(companyDoc.toObject()))
        };
    } catch (e) {
        return {
            success: false,
            error: 'Failed to approve company onboarding'
        };
    }
}
async function getPendingCompanies() {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])();
        const companies = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Company$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Company"].find({
            approved: false
        }).sort({
            createdAt: -1
        }).lean();
...
async function getPendingSuppliers() {
    try {
        ...
        return {
            success: false,
            error: 'Failed to fetch pending suppliers'
        };
    }
}
...
/* __next_internal_action_entry_do_not_use__ [{"401bd6106b073785c97ae1147b3f8a806c27cad682":"$$RSC_SERVER_ACTION_1","407b7f0558ba869a52431e787c3c567985b380b581":"$$RSC_SERVER_ACTION_0"},"",""] */ __turbopack_context__.s([
    "$$RSC_SERVER_ACTION_0",
    ()=>$$RSC_SERVER_ACTION_0,
    "$$RSC_SERVER_ACTION_1",
    ()=>$$RSC_SERVER_ACTION_1,
...
const $$RSC_SERVER_ACTION_0 = async function action($$ACTION_CLOSURE_BOUND) {
    var [$$ACTION_ARG_0] = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$app$2d$render$2f$encryption$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["decryptActionBoundArgs"])("407b7f0558ba869a52431e787c3c567985b380b581", $$ACTION_CLOSURE_BOUND);
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$admin$2d$approval$2d$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["approveCompanyOnboarding"])(String($$ACTION_ARG_0));
};
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])($$RSC_SERVER_ACTION_0, "407b7f0558ba869a52431e787c3c567985b380b581", null);
const $$RSC_SERVER_ACTION_1 = async function action($$ACTION_CLOSURE_BOUND) {
    var [$$ACTION_ARG_0] = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$app$2d$render$2f$encryption$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["decryptActionBoundArgs"])("401bd6106b073785c97ae1147b3f8a806c27cad682", $$ACTION_CLOSURE_BOUND);
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$admin$2d$approval$2d$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["approveSupplierOnboarding"])(String($$ACTION_ARG_0));
};
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])($$RSC_SERVER_ACTION_1, "401bd6106b073785c97ae1147b3f8a806c27cad682", null);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__eeec3e54._.js.map