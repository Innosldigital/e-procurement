...
function ReportsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ReportsPage.useEffect": ()=>{
            let mounted = true;
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$data$3a$aebc18__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getRequisitions"])().then({
                "ReportsPage.useEffect": (res)=>{
                    ...
                    const top = Object.entries(totals).map({
                        "ReportsPage.useEffect.top": ([category, amount])=>({
                                category,
                                amount
                            })
                    }["ReportsPage.useEffect.top"]).sort({
                        "ReportsPage.useEffect.top": (a, b)=>b.amount - a.amount
                    }["ReportsPage.useEffect.top"]).slice(0, 5);
                    if (!mounted) return;
                    setCategoryData(top);
                }
...
_s(ReportsPage, "mJk/uyBdyrec0PuruXExXZ1u5xI=");
_c = ReportsPage;
var _c;
