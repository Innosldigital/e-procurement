            ...
            <div className="bg-white rounded-lg shadow">
              ...
              <div className="p-4 bg-blue-50 border-t">
                <p className="text-xs text-blue-800">
                  💡 Tip: Switch &quot;View&quot; to see only POs blocked by invoice or receipt issues.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="bg-white rounded-lg shadow">
                <div className="p-6 border-b">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      <h2 className="text-xl font-bold text-gray-900">{selectedPO.poNumber} · {selectedPO.supplier}</h2>
                ...
                <div className="p-6 border-b">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <div className="text-gray-900">${fmtAmount(selectedPO.total)} · Tax exclusive</div>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <div className="text-gray-900">Issued: {fmtDate(selectedPO.keyDates?.issued)} · Delivery: {fmtDate(selectedPO.keyDates?.requestedDelivery)}</div>
                    </div>
                  </div>
                </div>
                    ...
                    {(selectedPO.approvalHistory || []).map((activity, i) => (
                      <div key={i} className="flex gap-3">
                        ...
                        <div className="flex-1 pb-4">
                          ...
                          <div className="text-sm text-gray-600 mt-1">{fmtDate(activity.date)}{activity.actor ? ` · ${activity.actor}` : ""}</div>
                        </div>
                      </div>
                    ))}
                  </div>
