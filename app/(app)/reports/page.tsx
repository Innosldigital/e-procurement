...
export default function ReportsPage() {
  ...
  return (
    <div ref={printRef} className="p-4 sm:p-6 lg:p-8">
      {/* Header */}
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-6">
        <div>
          <h1 className="text-xl sm:text-2xl font-semibold mb-2">Reports</h1>
          <p className="text-sm text-muted-foreground">
            Analyze spend, compliance, and cycle times.
          </p>
        </div>
      ...
      <div className="bg-card border rounded-lg p-4 sm:p-6 mb-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
          ...
          <div>
            <span className="text-muted-foreground">Currency:</span>{" "}
            <span className="font-medium">NLE</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-card border rounded-lg p-4 sm:p-6">
          <h3 className="text-sm font-medium mb-4">Cycle times</h3>
          <div className="space-y-3">
            <div className="flex justify-between">
              <span className="text-sm text-muted-foreground">Req → PO</span>
              <span>{cycleReqToPO.toFixed(1)}d</span>
            </div>
            <div className="flex justify-between">
              <span className="text-sm text-muted-foreground">
                PO → Invoice
              </span>
              <span>{cyclePOToInv.toFixed(1)}d</span>
            </div>
            <div className="flex justify-between">
              <span className="text-sm text-muted-foreground">
                Invoice → Pay
              </span>
              <span>{cycleInvToPay.toFixed(1)}d</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <Dialog open={customOpen} onOpenChange={setCustomOpen}>
        <DialogContent className="w-[95vw] max-w-2xl">
          <DialogHeader>
            <DialogTitle>Build custom report</DialogTitle>
            <DialogDescription>
              Configure parameters and generate report
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button variant="outline" onClick={() => setCustomOpen(false)}>
