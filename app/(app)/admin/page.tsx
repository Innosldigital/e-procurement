    ...
    <CardContent className="p-4">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="text-sm font-semibold text-foreground wrap-break-words">
            {value || "-"}
          </div>
        </div>
      </div>
...
const SectionHeader = ({ title }: any) => (
  <div className="flex items-center gap-3 mb-4">
    <div className="h-6 w-1 bg-linear-to-b from-primary to-primary/50 rounded-full" />
  ...
  return (
    <>
      ...
      <Dialog open={detailsOpen} onOpenChange={setDetailsOpen}>
        <DialogContent className="sm:max-w-6xl max-h-[95vh] flex flex-col p-0 overflow-hidden gap-0 bg-linear-to-br from-background via-background to-muted/20 overflow-y-auto">
            ...
            {detailsLoading ? (
              ...
              <div className="space-y-8">
                ...
                <Card className="border-2 border-primary/20 shadow-lg overflow-hidden">
                  <div className="h-24 bg-linear-to-r from-primary via-primary/80 to-primary/60" />
                  <CardContent className="p-6 -mt-12">
                    <div className="flex items-start gap-6">
                      <Avatar className="w-24 h-24 ring-4 ring-background shadow-xl">
                        ...
                        />
                        <AvatarFallback className="text-2xl font-bold bg--to-br from-primary to-primary/70 text-primary-foreground">
