...
//       if (!md.superAdminWelcomeSent && email) {
//         await sendEmail(
//           email,
//           "Super admin access granted",
//           "<p>Your super admin access has been enabled.</p>",
//           "/admin",
//           "Open Admin"
//         );
//         await client.users.updateUser(userId, {
//           publicMetadata: { ...md, superAdminWelcomeSent: true },
//         });
//       }
//     }
//   }
...
//   // Compact NLe formatter (K / M)
//   const fmtNLeCompact = (amount: number) =>
//     new Intl.NumberFormat("en-SL", {
//       style: "currency",
//       currency: "SLE",
//       notation: "compact",
...
//     .sort(
//       (a, b) =>
//         new Date(b?.keyDates?.issued || "").getTime() -
//         new Date(a?.keyDates?.issued || "").getTime()
//     )
//     .slice(0, 5);
...
//       ? (notificationsResult as any).data
//       : notificationsPublicResult.success
//       ? (notificationsPublicResult as any).data
//       : []
//   ) as NotificationItem[];
...
//             Monitor spend, track approvals, and manage procurement activity in
//             real-time.
//           </p>
//         </div>
//         <DashboardClient />
...
//                 <CardDescription className="text-xs">
//                   Track spend across branches and categories.
//                 </CardDescription>
//               </div>
...
//                 </CardTitle>
//                 <CardDescription className="text-xs">
//                   Orders in progress across branches.
//                 </CardDescription>
//               </div>
//               <span className="text-xs text-muted-foreground">
...
export default async function DashboardPage() {
  ...
  const pendingApprovals = pendingApprovalsCountResult.success
    ? (pendingApprovalsCountResult as any).count
    : Array.isArray(pendingApprovalsItems)
    ? pendingApprovalsItems.length
    : 0;

  console.log("Dashboard - Pending Approvals Count:", pendingApprovals);
  ...
  console.log("Dashboard - Open POs Count:", openPOs);
  console.log("Dashboard - Total POs:", purchaseOrders.length);
