...
export default function OnboardingContent() {
  ...
  const [declCombined, setDeclCombined] = useState(false);
  const [declAgreeTerms, setDeclAgreeTerms] = useState(false);
  ...
  const validateForm = () => {
    ...
    if (!declCombined) errors.push("Declaration Agreement");
    if (!declAgreeTerms) errors.push("Terms & Conditions Agreement");
  ...
  const submitSupplier = async () => {
    try {
      ...
      const res = await submitSupplierOnboarding({
        ...
        paymentMethods,
        vendorPaymentTerms:
          "Company will pay 40% part payment and 60% upon delivery",
        businessLeadGender,
        ...
        averageTurnover,
        declarations: {
          infoAccurate: declCombined,
          agreeRules: declCombined,
          agreeTerms: declAgreeTerms,
        },
      });
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-4 p-4 rounded-lg border border-border bg-muted/30">
                    <div className="flex items-start space-x-3">
                      <Checkbox
                        id="declCombined"
                        checked={declCombined}
                        onCheckedChange={(checked) =>
                          setDeclCombined(checked as boolean)
                        }
                      />
                      <Label
                        htmlFor="declCombined"
                        className="text-sm font-normal cursor-pointer leading-relaxed"
                      >
                        I confirm that all information provided is accurate and
                        complete to the best of my knowledge, and I agree to
                        comply with all procurement and delivery rules and
                        regulations of the platform. I also accept the payment
                        terms, which require a 40% part payment and the
                    ...
                    <div className="flex items-start space-x-3">
                      <Checkbox
                        id="declAgreeTerms"
                        checked={declAgreeTerms}
                        onCheckedChange={(checked) =>
                          setDeclAgreeTerms(checked as boolean)
                        }
                      />
                      <Label
                        htmlFor="declAgreeTerms"
                        className="text-sm font-normal cursor-pointer leading-relaxed"
                      >
                        I agree to the{" "}
                        <button
