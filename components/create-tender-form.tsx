...
// ✅ FIXED: Use exact same categories as onboarding form
const PRODUCT_CATEGORIES = [
  "Catering/Consumables",
  "Logistics",
  "Merchandise & Stationery",
  "Facilities (Venue)", // Changed from "Facilities & Venue"
] as const;
...
export function CreateTenderForm({ onClose }: CreateTenderFormProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-sm px-4">
      <div className="relative w-full max-w-lg sm:max-w-xl md:max-w-2xl lg:max-w-4xl max-h-[90vh] overflow-y-auto bg-background border rounded-lg shadow-lg">
        {/* Header */}
        <div className="sticky top-0 z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b bg-background px-4 sm:px-6 py-4">
          <div>
